...
const App = {
    ...
    init() {
        ...
        // FIX: Initialize Supabase client using the imported 'createClient' function,
        // which resolves the "Supabase client not loaded" error. This method
        // uses modern ES modules via the importmap in index.html instead of
        // relying on a global script.
